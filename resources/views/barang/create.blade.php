...
@section('page-subtitle', 'Isi formulir untuk menambahkan barang baru')
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-0 py-3">
                <h5 class="card-title mb-0">
                    <i class="bi bi-plus-circle me-2 text-primary"></i>Form Tambah Barang
                </h5>
            </div>
            <div class="card-body">
