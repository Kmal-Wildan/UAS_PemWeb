...
@section('page-subtitle', 'Lihat data barang dan laporan (read-only)')

@section('content')
<div class="alert alert-info d-flex align-items-center mb-4" role="alert">
    <i class="bi bi-info-circle fs-5 me-3"></i>
    <div>
        <strong>Mode Read-Only</strong> — Sebagai User, Anda hanya dapat melihat data barang dan laporan.
    </div>
</div>
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0"><i class="bi bi-eye me-2 text-primary"></i>Barang Terbaru</h5>
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('barang.index') }}" class="btn btn-outline-primary">
                        <i class="bi bi-table me-2"></i>Lihat Barang
                    </a>
